...
prompt_templates = {
    'mention': '{input_text}\n\nThe mention "{mention}" between <MENTION> and </MENTION> could refer to an entity with the name of {latent_mention_seeds} .',
    'entity': '{description_text}\n\nThe text is describing an entity named {latent_entity_seeds} .',
}